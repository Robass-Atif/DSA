...
public:
    ...
    public:
        ...
        int col;
        // Cell Construtor
        cell(string val, int row, int col)
        {
            this->row = row;
            this->col = col;
            value = val;
    ...
    void GetRangeSum(cell *RangeStart, cell *RangeEnd)
    {
        ...
        while (temp != NULL && temp != RangeEnd)
        {
            ...
            sum += stoi(temp->value); // Convert character to integer
    ...
    void GetRangeAverage(cell *RangeStart, cell *RangeEnd)
    {
        ...
        //         active->value =  to_string( int(sum / count));
        //     }
        // }
        if (temp == NULL)
        {
    ...
    void inputForMax()
    {
        ...
        int row, col, r1, c1;
        cin >> row;
        cout << "Enter the coloumn of starting cell: ";
        cin >> col;
        cout << "Enter the row of ending cell :";
        cin >> r1;
        cout << "Enter the coloumn of ending cell: ";
...
int main()
{
    ...
    while (true)
    {
        ...
        if (GetAsyncKeyState('I') && GetAsyncKeyState(VK_SHIFT))// clear cloumn
        {
            system("cls");
            m.clearColoumn();
            printHeader();
        ...
        if (GetAsyncKeyState(VK_DELETE))// delete cell by left shift
        {
            system("cls");
        ...
        if (GetAsyncKeyState('E') && GetAsyncKeyState(VK_SHIFT))// delete coloumn
        {
            system("cls");
            m.deleteColoumn();
            printHeader();
        ...
        if (GetAsyncKeyState('T') && GetAsyncKeyState(VK_SHIFT)) //change data of cell
        {
            m.changeData();
            system("cls");
            printHeader();
        ...
        if (GetAsyncKeyState(VK_LCONTROL) && GetAsyncKeyState('Q'))// delete cell by up shift
        {
            system("cls");
            m.DeleteCellByUpShift();
            printHeader();

            m.printSheet();
        }
        if (GetAsyncKeyState(VK_LCONTROL) && GetAsyncKeyState('W'))// delete row
        {
            system("cls");
            m.deleteRow();
            printHeader();
        ...
        if(GetAsyncKeyState(VK_SHIFT) && GetAsyncKeyState('U'))// copy command
        {
        ...
        if (GetAsyncKeyState(VK_LCONTROL) && GetAsyncKeyState('D'))// cut command
        {
        ...
        if (GetAsyncKeyState(VK_LCONTROL) && GetAsyncKeyState('O'))// paste command
        {
        ...
        if (GetAsyncKeyState('S') && GetAsyncKeyState(VK_SHIFT))// sum function
        {
        ...
        if (GetAsyncKeyState('A') && GetAsyncKeyState(VK_CONTROL))// average function
        {
            m.InputForAverage();
            system("cls");
            printHeader();
        ...
        // for min function
        if (GetAsyncKeyState('M') && GetAsyncKeyState(VK_SHIFT))// min function
        {
            m.inputForMIN();
        ...
        // for max function
        if (GetAsyncKeyState('X') && GetAsyncKeyState(VK_SHIFT))// max function
        {
            m.inputForMax();
